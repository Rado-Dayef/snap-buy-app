                      ...
                      child: TextFormFieldWidget(
                        ...
                        validator: (String? value) {
                          if (value == null || value.isEmpty) {
                            return Strings.nameText + Strings.spaceSign + Strings.isRequiredValidation;
                          } else if (value.length < 4) {
                            return Strings.nameText + Strings.spaceSign + Strings.lessThen4Validation;
                          } else if (value.length > 24) {
                            return Strings.nameText + Strings.spaceSign + Strings.largerThen24Validation;
                          }
                          return null;
                        },
                      ),
